...
class MainWindow:
    def __init__(self, root):
        ...
        self.center_window(self.root)  # Centrar la ventana principal
...
class DownloadWindow(CenteredWindow):
    def __init__(self, parent):
        super().__init__(parent, "Descargar expedientes", 730, 700)
        self.resizable(False, False)
...
class ProcessWindow(CenteredWindow):
    def __init__(self, parent):
        super().__init__(parent, "Procesa expediente copiado en memoria", 700, 600)
        self.resizable(False, False)
...
class InfoWindow(CenteredWindow):
    def __init__(self, parent):
        super().__init__(parent, "Información", 700, 450)
        self.resizable(False, False)
